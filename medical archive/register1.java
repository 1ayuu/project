...
public class register1{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					 register1 window = new  register1();
	...
	private void initialize() 
	{
		...
		txtUsername.setBounds(266, 195, 229, 40);
		...
		lblUsername.setBounds(101, 195, 211, 40);
		...
		textField_3.setBounds(266, 299, 229, 40);
		panel_1.add(textField_3);
		
		JLabel lblLastName = new JLabel("Liscene_Number");
		lblLastName.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblLastName.setBounds(101, 316, 154, 40);
