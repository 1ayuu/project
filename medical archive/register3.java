...
public class register3{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					 register3 window = new  register3();
	...
	private void initialize() 
	{
		...
		panel_1.setBounds(518, 11, 602, 765);
		panel.add(panel_1);
		...
		txtUsername.setBounds(171, 315, 229, 40);
		...
		JLabel lblUsername = new JLabel("Verification Code");
		lblUsername.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblUsername.setBounds(218, 235, 211, 40);
